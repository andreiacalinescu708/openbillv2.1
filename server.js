...
app.post("/api/demo-signup", async (req, res) => {
  return res.status(410).json({ 
    error: "Acest endpoint nu mai este disponibil",
    message: "Folosește noul sistem de înregistrare de pe pagina principală",
    redirect: "/register.html"
  });
});

// Endpointul vechi complet - eliminat pentru a menține codul curat
